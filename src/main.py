...
def main():
    ...
    try:
        ...
        st.markdown(
            "<h1 style='text-align: center; color: #D9895B; font-size: 4.5rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.1);'>EcoVid</h1>",
            unsafe_allow_html=True,
        )

    # MODIFICACIÓN: Color del subtítulo cambiado a blanco (#EAEAEA)
    st.markdown(
        "<p style='text-align: center; margin-top: -20px; font-size: 1.1rem; color: #EAEAEA;'>Herramienta para la segmentación de imágenes hiperespectrales y detección de cobre en viñedos.</p>",
        unsafe_allow_html=True,
    )
