...
from ecovid.report import build_zip_report
...
if st.session_state.get("processed", False):
    mostrar_previsualizacion_y_resultados()
    # Botón para exportar ZIP de reporte
    if st.button("📦 Exportar reporte ZIP", use_container_width=True):
        ...
        with open(zpath, "rb") as f:
            st.download_button("Descargar ZIP", f, file_name="reporte.zip", mime="application/zip")
