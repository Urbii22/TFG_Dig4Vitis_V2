...
% Datos de portada
\title{Análisis de imágenes hiperespectrales para la detección de cobre en viñedo (proyecto Dig4Vitis v2)}
\author{Diego Urbaneja Portal}
\tutor{Carlos Cambra Baseca y Ramón Sánchez Alonso}
\date{\today}
...
\noindent Dr. Carlos Cambra Baseca y Dr. Ramón Sánchez Alonso, del departamento de Digitalización.

\noindent Exponen:

\noindent Que el alumno D. Diego Urbaneja Portal, con DNI 71305446H, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado Análisis de imágenes hiperespectrales para la detección de cobre en viñedo (proyecto Dig4Vitis v2). 
...
\begin{abstract}
Este trabajo, enmarcado en el área de la agricultura de precisión, se centra en el desarrollo y la implementación de una herramienta software, \textbf{EcoVid},  para la detección y cuantificación de tratamientos antifúngicos con base de cobre en hojas de viñedo.
...
Como resultado, \textbf{EcoVid} ofrece una imagen procesada que muestra, de forma resaltada, la parte de la hoja de vid afectada por el tratamiento de producto y el porcentaje de cobertura, de forma numérica. La aplicación ofrece la opción de descargar los resultados en formato .jpg. 
...
As a result, \textbf{EcoVid} provides a processed image that highlights the portion of the grapevine leaf affected by the product treatment and numerically displays the coverage percentage. The application offers the option to download the results in .jpg format.
